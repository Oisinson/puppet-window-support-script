...
Get-Eventlog -source "puppet" -logname "Application" -ErrorAction SilentlyContinue | Format-List Index, Time, EntryType, Message *>> ($supportfolder + "/pastrunlogs.txt")
Get-Eventlog -source "pxp-agent" -logname "Application" -ErrorAction SilentlyContinue | Format-List Index, Time, EntryType, Message *>> ($supportfolder + "/pxp-agent.txt")
Get-Eventlog -source "mcollective" -logname "Application" -ErrorAction SilentlyContinue | Format-List Index, Time, EntryType, Message *>> ($supportfolder + "/mcollective.txt")
